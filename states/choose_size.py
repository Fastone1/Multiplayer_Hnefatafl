...
class ChooseSize(State):
    def __init__(self, game: Game):
        ...
        self.button_9x9 = Button(self.game, (button_pos[0] * 3 // 5, button_pos[1]), True, "9x9", self.game.font_small, button_size, button_color)
        self.button_11x11 = Button(self.game, (button_pos[0] * 7 // 5, button_pos[1]), True, "11x11", self.game.font_small, button_size, button_color)
